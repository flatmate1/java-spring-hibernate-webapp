   ...
   <c:forEach items="${paginationProducts.list}" var="prodInfo">
       <div class="product-preview-container">
           <ul>
               ...
               <li>
               	   <a
                   href="${pageContext.request.contextPath}/addToCart?code=${prodInfo.code}">
                       Buy Now</a>
                   <a  
                   href="${pageContext.request.contextPath}/productdetail/${prodInfo.code}">
                       Detail</a>
                       
                       </li>
               <!-- For Manager edit ProWduct -->
